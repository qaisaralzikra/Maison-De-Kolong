...
class Azka extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(backgroundColor: Colors.white, body: stack()),
    );
  }
}
        ...
        child: Column(
          ...
          children: [
                        ...
                        Container(
                          child: Row(
                            children: [
                              ...
                              Text('Takeaway', style: TextStyle(fontSize: 10)),
                            ],
                          ),
                        ),
                        SizedBox(width: 10),
                        Container(
                          child: Row(
                            children: [
                              ...
                              Text('Dine In', style: TextStyle(fontSize: 10)),
                            ],
                          ),
                        ),
                      ],
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(child: Image.asset('image/cup.png', height: 104)),
                  SizedBox(width: 20),
                  Container(
                    decoration: BoxDecoration(
                      color: Colors.white,
                ...
                children: [
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        child: Image(
                                          image: AssetImage('image/cup.png'),
                                        ),
                                      ),
                                    ],
                                  ),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Colors.white, // tanpa warna background
                      shadowColor:
                            ...
                            child: Row(
                              children: [
                                Container(
                                  child: Image(
                                    width: 60,
                                    image: AssetImage('image/logo_halal.png'),
                                  ),
                                ),
                                Container(
                                  child: Text(
